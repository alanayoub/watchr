...
CREATE TABLE `login_attempt` (
  ...
  CONSTRAINT `fk_login_attempt_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `result` (
  ...
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_results_task1` (`task_id`,`task_user_id`),
  CONSTRAINT `fk_results_task1` FOREIGN KEY (`task_id`, `task_user_id`) REFERENCES `task` (`id`, `user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (2,'alan','pass','somerandomsalt','2013-12-15 18:55:06');
...
-- Dump completed on 2013-12-17 10:13:56
